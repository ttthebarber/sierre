...
export const WooCommerceIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M23.1 10.8c-.2-3.9-2.8-7.2-6.4-8.5C15.1 1.1 13.1.6 11 .6c-2.1 0-4.1.5-5.7 1.7C1.7 3.6-.1 6.9.1 10.8c.2 3.9 2.8 7.2 6.4 8.5 1.6 1.2 3.6 1.7 5.7 1.7 2.1 0 4.1-.5 5.7-1.7 3.6-1.3 6.2-4.6 6.2-8.5zm-11 8.7c-4.8 0-8.7-3.9-8.7-8.7S7.2 2.1 12 2.1s8.7 3.9 8.7 8.7-3.9 8.7-8.7 8.7z"
      fill="currentColor"
    />
    <path
      d="M18.5 9.3c-.1-.4-.3-.7-.6-.9l-2.8-2.1c-.4-.3-.9-.3-1.3 0L12 7.7 10.2 6.3c-.4-.3-.9-.3-1.3 0L6.1 8.4c-.3.2-.5.5-.6.9-.1.4 0 .8.3 1.1l1.8 1.4-1.8 1.4c-.3.3-.4.7-.3 1.1.1.4.3.7.6.9l2.8 2.1c.2.1.4.2.6.2s.4-.1.6-.2L12 16.2l1.8 1.4c.2.1.4.2.6.2s.4-.1.6-.2l2.8-2.1c.3-.2.5-.5.6-.9.1-.4 0-.8-.3-1.1L16.3 12l1.8-1.4c.3-.3.4-.7.4-1.3z"
      fill="currentColor"
    />
  </svg>
)
